...
`,classes:{root:function(e){var t=e.props;return[`p-skeleton p-component`,{"p-skeleton-circle":t.shape===`circle`,"p-skeleton-animation-none":t.animation===`none`}]}},inlineStyles:{root:{position:`relative`}}}),Je={name:`BaseSkeleton`,extends:h,props:{shape:{type:String,default:`rectangle`},size:{type:String,default:null},width:{type:String,default:`100%`},height:{type:String,default:`1rem`},borderRadius:{type:String,default:null},animation:{type:String,default:`wave`}},style:qe,provide:function(){return{$pcSkeleton:this,$parentInstance:this}}};function Z(e){"@babel/helpers - typeof";return Z=typeof Symbol==`function`&&typeof Symbol.iterator==`symbol`?function(e){return typeof e}:function(e){return e&&typeof Symbol==`function`&&e.constructor===Symbol&&e!==Symbol.prototype?`symbol`:typeof e},Z(e)}function Ye(e,t,n){return(t=Xe(t))in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}function Xe(e){var t=Ze(e,`string`);return Z(t)==`symbol`?t:t+``}function Ze(e,t){if(Z(e)!=`object`||!e)return e;var n=e[Symbol.toPrimitive];if(n!==void 0){var r=n.call(e,t);if(Z(r)!=`object`)return r;throw TypeError(`@@toPrimitive must return a primitive value.`)}return(t===`string`?String:Number)(e)}var Q={name:`Skeleton`,extends:Je,inheritAttrs:!1,computed:{containerStyle:function(){return this.size?{width:this.size,height:this.size,borderRadius:this.borderRadius}:{width:this.width,height:this.height,borderRadius:this.borderRadius}},dataP:function(){return C(Ye({},this.shape,this.shape))}}},Qe=[`data-p`];function $e(e,n,i,a,o,s){return r(),m(`div`,t({class:e.cx(`root`),style:[e.sx(`root`),s.containerStyle],"aria-hidden":`true`},e.ptmi(`root`),{"data-p":s.dataP}),null,16,Qe)}Q.render=$e;var et={class:``},tt={class:`flex flex-wrap items-center justify-between gap-4`},$={class:`flex items-center gap-2`},nt={key:0,class:`grid grid-cols-2 gap-3 justify-center text-center`},rt=[`src`],it={key:1,class:`w-40 h-40 rounded-lg mr-2 bg-surface-800 flex items-center justify-center`},at={class:`text-left flex flex-col gap-1 text-align-center`},ot={class:`text-surface-200`},st=[`href`],ct={class:`text-sm text-surface-500`},lt={key:1,class:`grid grid-cols-2 gap-3 justify-center text-center`},ut={class:`text-left flex flex-col gap-1 text-align-center`},dt=k(j({__name:`LastsSong`,setup(e){let t=c(null);return p(async()=>{t.value=await Ke()}),(e,n)=>{let a=S(`v-icon`);return r(),b(i(N),{class:`w-full max-w-md hover-panel`},{header:x(()=>[w(`h2`,et,[g(a,{name:`fa-music`,class:`mr-2`}),n[1]||=M(`Last played song `,-1),g(i(U),{severity:`danger`},{default:x(()=>[...n[0]||=[M(`last.fm`,-1)]]),_:1})])]),footer:x(()=>[w(`div`,tt,[n[2]||=w(`span`,{class:`text-surface-500 text-surface-600 text-sm`},`API used: biancarosa/lastfm-last-played`,-1),w(`div`,$,[g(i(D),{severity:`secondary`,rounded:``,as:`a`,href:`https://github.com/biancarosa/lastfm-last-played`,target:`_blank`,rel:`noopener noreferrer`},{default:x(()=>[g(a,{name:`fa-external-link-alt`})]),_:1})])])]),default:x(()=>[t.value==null?(r(),m(`div`,lt,[g(i(Q),{width:`160px`,height:`160px`,class:`rounded-lg mr-2`}),w(`div`,ut,[g(i(Q),{width:`100%`,height:`30px`,class:`mb-2`}),g(i(Q),{width:`100%`,height:`20px`})])])):(r(),m(`div`,nt,[t.value.image==``?(r(),m(`div`,it,[g(a,{name:`fa-music`,class:`text-surface-500 text-4xl`})])):(r(),m(`img`,{key:0,src:t.value.image,class:`w-40 h-auto rounded-lg mr-2`},null,8,rt)),w(`div`,at,[t.value.nowPlaying?(r(),b(i(R),{key:0,label:`Now Playing`,class:`bg-success text-surface-950 font-bold text-sm mb-2 w-full now-playing`})):(r(),b(i(R),{key:1,label:`Last Played on `+t.value.date,class:`bg-surface-700 text-surface-200 font-bold text-sm mb-2 w-full`},null,8,[`label`])),w(`div`,null,[w(`p`,ot,[w(`a`,{href:t.value.url,target:`_blank`,rel:`noopener noreferrer`},d(t.value.name),9,st)]),w(`p`,ct,d(t.value.artist),1)])])]))]),_:1})}}}),[[`__scopeId`,`data-v-e656212d`]]),ft={class:`gap-2 flex`},pt={class:`flex flex-row gap-4 mt-4 intro-buttons`},mt=k(j({__name:`Intro`,setup(e){return(e,t)=>{let n=S(`router-link`);return r(),m(v,null,[t[2]||=w(`h1`,{class:`text-6xl font-bold minecraft mt-0 md:mt-5`},`Ivan Mansilla`,-1),w(`div`,ft,[g(i(R),{label:`🛠️ Full Stack Developer`,class:`bg-primary text-surface-950 font-bold text-lg hover-chip`}),g(i(R),{label:`🐧 Linux Enthusiast`,class:`bg-primary text-surface-950 font-bold text-lg hover-chip`})]),t[3]||=w(`p`,null,`4th year Computer Engineering Student based in Chile`,-1),w(`div`,pt,[g(n,{to:`/about`},{default:x(()=>[g(i(D),{severity:`help`,class:`mt-4 hover-button`},{default:x(()=>[g(i(re)),t[0]||=M(` About Me `,-1)]),_:1})]),_:1}),g(i(D),{severity:`secondary`,variant:`outlined`,class:`mt-4 hover-button`,as:`a`,href:`https://github.com/ivnmansi`,target:`_blank`,rel:`noopener noreferrer`},{default:x(()=>[g(i(ne)),t[1]||=M(` Github `,-1)]),_:1})])],64)}}}),[[`__scopeId`,`data-v-71c4d376`]]),ht={class:`grid w-full flex-1 content-center grid-cols-1 gap-4 md:grid-cols-2`},gt={class:`flex min-h-[calc(100dvh-6rem)] flex-col items-center justify-center gap-4 p-4 text-center md:min-h-0`},_t={class:`flex flex-col items-center gap-4 p-4 justify-center text-center`},vt=j({__name:`Home`,setup(e){return(e,t)=>(r(),m(`div`,ht,[w(`div`,gt,[g(mt)]),w(`div`,_t,[g(We),g(dt)])]))}});export{vt as default};